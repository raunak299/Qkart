...
const Navbar = () => {
    ...
    return (
        <div className={styles['navbar']}>
            ...
            <div className={styles['navbar-center-1']}>
                <Link to='/home'>
                    <div className={searchClicked ? styles["hidden"] : styles['app-logo']} >
                    ...
                    <div className={`${searchClicked ? styles['search-section-1'] : styles['search-section-closed']} `}>
                        <div className={searchClicked ? styles['search-bar-1'] : ""}>
                            <div className={searchClicked ? styles["search-icon-container"] : ''} >
                                <i className={`fa fa-light fa-magnifying-glass ${styles['search-icon-1']}`} onClick={searchClickHandler}></i>
                            </div>
                            {searchClicked && <input type="text" name="search-input" className={styles['search-input-1']} placeholder='Search for shirt jeans ..' />}
                            {searchClicked && <i className=" fa fa-solid fa-x" id={styles["cross-icon-1"]} onClick={crossClickHandler}></i>}
                        </div>
