        ...
        <React.Fragment>
            <div className={styles['auth-page']}>
                <div className={styles['auth-section']}>
                    ...
                    <div className={styles['auth-section-heading']}>Register</div>
                    <form action='' className={styles['auth-form']}>
                        <div className={styles['auth-name']}>
                            <label for='name'> Name </label>
                            <input type='text' name='name' id={styles['name']} />
                        </div>
                    ...
                    <div className={styles['toggle-login-register']}>login/logout</div>
                </div>
            </div>
        </React.Fragment >
    );
